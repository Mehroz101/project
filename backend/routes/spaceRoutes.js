...
const {createSpace,showSpace,toggleSpaceStatus,getspacedetail, updateSpaceDetails,deleteSpace, getallspaces,getspacedetailforreservation} = require('../controllers/spaceController');
...
router.get("/getspacedetailforreservation/:spaceId", authenticateToken, getspacedetailforreservation);
